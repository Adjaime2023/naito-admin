<template>
    <div class="mx-2 px-4 pt-4 pb-6 bg-gray-200 dark:bg-gray-800 rounded-lg">
        ...
        <button
            ...
            :class="{
                'bg-gray-300 dark:bg-gray-900/80 text-gray-800 dark:text-white':
                    activeTab === 'info',
                'bg-gray-200 dark:bg-gray-500/70 text-gray-400 dark:text-700':
                    activeTab !== 'info',
            }"
            class="px-4 py-2 mr-2 rounded-t focus:outline-none"
            title="Informações do Banner"
        >
        ...
        <button
            ...
            class="px-4 py-2 mr-2 rounded-t focus:outline-none"
            title="Imagens Mobile/Tablet"
        >
            Imagens Mobile/Tablet
        </button>
        <button
            @click="activeTab = 'images2'"
            :class="{
                'bg-gray-300 dark:bg-gray-900/80 text-gray-800 dark:text-white':
                    activeTab === 'images2',
                'bg-gray-200 dark:bg-gray-500/70 text-gray-400 dark:text-700':
            ...
            class="px-4 py-2 mr-2 rounded-t focus:outline-none"
            title="Imagens Laptop/Desktop"
        >
            Imagens Laptop/Desktop
        </button>
        ...
        <div v-show="activeTab === 'info'">
            <form @submit.prevent="updateBanner" enctype="multipart/form-data">
                <div
                    class="px-4 py-4 pb-6 bg-gray-300 dark:bg-gray-900/80 rounded-b-lg rounded-r-lg"
                >
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <div class="col-span-1 sm:col-span-2 md:col-span-2">
                            <InputLabel for="description2"
                                >Descrição 2</InputLabel
                            >
                            <TextInput
                    ...
                    <PrimaryButton
                        class="my-2 w-1/3 sm:w-1/4 md:1/5 lg:w-1/6 text-center "
        ...
        <div class="flex items-center justify-center w-full mt-4">
            <ButtonLink
                ...
                :active="route().current('banner.create')"
