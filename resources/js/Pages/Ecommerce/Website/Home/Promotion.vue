<template>
        ...
        <section v-if="products.length > 0"  id="promotion"
        class="pb-12 mt-10 bg-gradient-to-b dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 from-gray-100 via-gray-200 to-gray-300">
            <div class="text-center mx-auto mb-[10px] max-w-[510px]">
                <h2 class="text-3xl font-semibold text-blue-900 dark:text-blue-400 mb-4">PROMOÇÕES</h2>
            </div>
                        ...
                        <div v-for="product in loopedProducts" :key="product.id"
                            ...
                            <div class="bg-gray-400 dark:bg-gray-900 rounded-[14px] h-full flex flex-col">
                                <div class="px-2 group flex flex-col items-center justify-center flex-grow">
                                    ...
                                    <div class="text-center flex-grow flex flex-col justify-between">
                                        <div>
                                            ...
                                            <p class="line-through">{{ formatter(product.sale_price) }}</p>
                                            <p class="text-lg font-bold text-green-500">{{
                                                formatter(product.promotion_price) }}
                                ...
                                <div class="mt-auto mb-2">
                                    <a :href="`https://api.whatsapp.com/send?phone=${phoneLink}&text=${encodeURIComponent(`Olá, estou interessado no produto, contato pelo site Parceiro.`)}`"
                                target="_blank"
...
onMounted(async () => {
    try {
        const response = await axios.get('/api/website/sitePromotion');
