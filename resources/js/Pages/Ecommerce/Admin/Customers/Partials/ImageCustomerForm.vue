        ...
        <form @submit.prevent="submitForm" method="post" enctype="multipart/form-data">
            <div class="grid justify-items-stretch items-center col-span-1 sm:col-span-1 md:col-span-1">
                ...
                <div class="flex justify-center mt-2">
                    <img :src="imagePreview" :alt="form.name" class="rounded h-60 w-full object-cover">
                </div>
...
const form = useForm({
    _method: 'PUT',
    image: props.customer.image, // Inicializa com a imagem existente do produto
});

// Variável reativa para a pré-visualização da imagem
const imagePreview = ref(props.customer.image ? `/storage/${props.customer.image}` : '/storage/images/default.png');
...
function submitForm() {
    ...
    form.post(route('customer.updateImage', { id: props.customer.id }), {
        onSuccess: () => {
