...
import ImageCustomerForm from './ImageCustomerForm.vue';
...
const form = useForm({
  ...
  person_type: props.customer?.person_type || '',
  document_number: props.customer?.document_number || '',
  identification_number: props.customer?.identification_number || '',
...
const updateCustomer = () => {
  form.put(route('customer.update', { id: form.id }), {
    onSuccess: () => {
      if (props.jetstream) {
        props.jetstream.flash = { message: 'Cliente atualizado com sucesso!' };
      }
    },
    onError: () => {
      if (props.jetstream) {
        props.jetstream.flash = { error: 'Erro ao atualizar o Cliente.' };
      }
    },
  });
};
    ...
    <div class="mx-2 px-4 pt-4 pb-6 bg-gray-200 dark:bg-gray-800 rounded-lg">
        <form @submit.prevent="updateCustomer" enctype="multipart/form-data">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                <div class="col-span-1 sm:col-span-1 md:col-span-1">
                    ...
                    <div class="flex items-center mt-1">
                        <select v-if="props.customerTypes && props.customerTypes.length"
                            ...
                            <option v-for="customer_type in props.customerTypes" :key="customer_type.id"
                ...
                <div class="col-span-1 sm:col-span-1 md:col-span-1">
                    ...
                    <div class="relative flex">
                        ...
                        <button type="button" @click="buscarEnderecoPorCEP"
                            class="absolute top-0 right-0 underline-offset-2 py-3  px-2 space-x-2 text-sm  customer_type  bg-gradient-to-r dark:from-cyan-900 dark:to-blue-900 from-blue-700  via-purple-700 to-purple-500   hover:dark:from-cyan-600 hover:dark:to-blue-600  bg-gray-600 hover:from-indigo-500 hover:via-purple-500 hover:to-purple-500 text-gray-100 rounded-r">
                            Buscar</button>
                    </div>
            ...
            <div class="flex items-center justify-center w-full mt-4">
                <ButtonLink :href="route('customer.create')" :active="route().current('customer.create')"
