        ...
        <form @submit.prevent="submitForm" method="post" enctype="multipart/form-data">
            <div class="grid justify-items-stretch items-center col-span-1 sm:col-span-1 md:col-span-1">
                ...
                <div class="flex justify-center mt-2">
                    <img :src="imagePreview" :alt="form.name" class="rounded  w-full  object-contain">
                </div>
...
const form = useForm({
    _method: 'PUT',
    image: props.employee.image, // Inicializa com a imagem existente do produto
});

// Variável reativa para a pré-visualização da imagem
const imagePreview = ref(props.employee.image ? `/storage/${props.employee.image}` : '/storage/images/default.png');
...
function submitForm() {
    ...
    form.post(route('employee.updateImage', { id: props.employee.id }), {
        onSuccess: () => {
