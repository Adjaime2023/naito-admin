        ...
        <form @submit.prevent="submit" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                <div class="col-span-1 sm:col-span-2 md:col-span-2">
                    <InputLabel for="name">Nome do Funcionário</InputLabel>
                ...
                <div class="col-span-1 sm:col-span-1 md:col-span-1">
                    ...
                    <div class="relative flex">
                        ...
                        <button type="button" @click="buscarEnderecoPorCEP"
                            class="absolute top-0 right-0 underline-offset-2 pt-2 pb-3  px-2 space-x-2 text-sm  bg-gradient-to-r dark:from-cyan-900 dark:to-blue-900 from-blue-700  via-purple-700 to-purple-500   hover:dark:from-cyan-600 hover:dark:to-blue-600  bg-gray-600 hover:from-indigo-500 hover:via-purple-500 hover:to-purple-500 text-gray-100 rounded-r">
                            Buscar</button>
                    </div>
