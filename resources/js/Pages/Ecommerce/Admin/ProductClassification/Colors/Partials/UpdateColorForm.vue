                ...
                <form @submit.prevent="submitForm" method="post" enctype="multipart/form-data">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        <div class="col-span-1 sm:col-span-2 md:col-span-3">
                            <InputLabel for="name">Nome do Cor</InputLabel>
                    ...
                    <div class="flex items-center justify-center w-full mt-4">
                        <ButtonLink :href="route('color.create')" class="w-1/6">
                            Nova
                        </ButtonLink>
                        ...
                        <ButtonLink :href="route('colors.show', form.id)" class="w-1/6">
                            Listar
                        </ButtonLink>
                    </div>
...
import ImageColorForm from './ImageColorForm.vue';
...
const form = useForm({
    ...
    discontinued: props.color.discontinued || false,
    deleted: props.color.deleted || false,
    action_user: actionUser.value + '|' + (props.color.action_user || ''),
...
function submitForm() {
    ...
    form.put(route('color.update', { id: form.id }), {
