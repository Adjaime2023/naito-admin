            ...
            <div class="mx-2 px-4 pt-4 pb-6 bg-gray-200 dark:bg-gray-800 rounded-lg">
                <form @submit.prevent="submitForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center justify-center w-full mt-4">
                        <ButtonLink :href="route('subgroup.create')" class="w-1/6">
                            Novo
                        </ButtonLink>
                        ...
                        <ButtonLink :href="route('subgroups.show', form.id)" class="w-1/6">
                            Listar
                        </ButtonLink>
                    </div>
...
import ImageSubgroupForm from './ImageSubgroupForm.vue';
...
const form = useForm({
    ...
    discontinued: props.subgroup.discontinued || false,
    deleted: props.subgroup.deleted || false,
    action_user: actionUser.value + '|' + (props.subgroup.action_user || ''),
...
function submitForm() {
    ...
    form.put(route('subgroup.update', { id: form.id }), {
