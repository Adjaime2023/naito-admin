...
const imagePreview = ref(props.subgroup.image ? `/storage/${props.subgroup.image}` : '/storage/images/default.png');
...
// Submeter formulário
function submitForm() {
    form.post(route('subgroup.updateImage', { id: props.subgroup.id }), {
