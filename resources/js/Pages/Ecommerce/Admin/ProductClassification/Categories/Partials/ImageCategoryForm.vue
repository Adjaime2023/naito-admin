        ...
        <form @submit.prevent="submitForm" method="post" enctype="multipart/form-data">
            <div class="grid justify-items-stretch items-center col-span-1 sm:col-span-1 md:col-span-1">
                ...
                <div class="flex justify-center mt-2">
                    <img :src="imagePreview" :alt="form.name" class="rounded w-full object-cover text-gray-700 dark:text-gray-400">
                </div>
...
const imagePreview = ref(props.category.image ? `/storage/${props.category.image}` : '/storage/images/default.png');
...
// Submeter formulário
function submitForm() {
    form.post(route('category.updateImage', { id: props.category.id }), {
