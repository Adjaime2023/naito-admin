                ...
                <form @submit.prevent="submitForm" method="post" enctype="multipart/form-data">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        <div class="col-span-1 sm:col-span-2 md:col-span-3">
                            <InputLabel for="name">Nome do Categoria</InputLabel>
                    ...
                    <div class="flex items-center justify-center w-full mt-4">
                        <ButtonLink :href="route('category.create')" class="w-1/6">
                            Novo
                        </ButtonLink>
                        ...
                        <ButtonLink :href="route('categories.show', form.id)" class="w-1/6">
                            Listar
                        </ButtonLink>
                    </div>
...
import ImageCategoryForm from './ImageCategoryForm.vue';
...
const form = useForm({
    ...
    discontinued: props.category.discontinued == 1 ? true : false,
    deleted: props.category.deleted == 1 ? true : false,
    action_user: actionUser.value + '|' + (props.category.action_user || ''),
...
function submitForm() {
    ...
    form.put(route('category.update', { id: form.id }), {
