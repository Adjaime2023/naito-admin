                ...
                <form @submit.prevent="submitForm" method="post" enctype="multipart/form-data">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        <div class="col-span-1 sm:col-span-2 md:col-span-3">
                            <InputLabel for="name">Nome da Coleção</InputLabel>
                    ...
                    <div class="flex items-center justify-center w-full mt-4">
                        <ButtonLink :href="route('collection.create')" class="w-1/6">
                            Novo
                        </ButtonLink>
                        ...
                        <ButtonLink :href="route('collections.show', form.id)" class="w-1/6">
                            Listar
                        </ButtonLink>
                    </div>
...
import ImageCollectionForm from './ImageCollectionForm.vue';
...
const form = useForm({
    ...
    discontinued: props.collection.discontinued || false,
    deleted: props.collection.deleted || false,
    action_user: actionUser.value + '|' + (props.collection.action_user || ''),
...
function submitForm() {
    ...
    form.put(route('collection.update', { id: form.id }), {
