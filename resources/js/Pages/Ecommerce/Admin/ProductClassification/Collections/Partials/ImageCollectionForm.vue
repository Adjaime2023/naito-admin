...
const imagePreview = ref(props.collection.image ? `/storage/${props.collection.image}` : '/storage/images/default.png');
...
// Submeter formulário
function submitForm() {
    form.post(route('collection.updateImage', { id: props.collection.id }), {
