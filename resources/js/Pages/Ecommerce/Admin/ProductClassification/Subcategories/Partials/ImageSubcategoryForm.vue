...
const imagePreview = ref(props.subcategory.image ? `/storage/${props.subcategory.image}` : '/storage/images/default.png');
...
// Submeter formulário
function submitForm() {
    form.post(route('subcategory.updateImage', { id: props.subcategory.id }), {
