                ...
                <form @submit.prevent="submitForm" method="post" enctype="multipart/form-data">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        ...
                        <div class="col-span-1 sm:col-span-2 md:col-span-2">
                            <InputLabel for="name">Nome do Grupo</InputLabel>
                    ...
                    <div class="flex items-center justify-center w-full mt-4">
                        <ButtonLink :href="route('group.create')" class="w-1/6">
                            Novo
                        </ButtonLink>
                        ...
                        <ButtonLink :href="route('groups.show', form.id)" class="w-1/6">
                            Listar
                        </ButtonLink>
                    </div>
...
import ImageGroupForm from './ImageGroupForm.vue';
...
const form = useForm({
    _method: 'PUT',
    subcategory_id: props.group.subcategory_id,
    id: props.group.id || '',
    name: props.group.name || '',
    description: props.group.description || '',
    discontinued: props.group.discontinued || false,
    deleted: props.group.deleted || false,
    action_user: actionUser.value + '|' + (props.group.action_user || ''),
...
function submitForm() {
    ...
    form.put(route('group.update', { id: form.id }), {
