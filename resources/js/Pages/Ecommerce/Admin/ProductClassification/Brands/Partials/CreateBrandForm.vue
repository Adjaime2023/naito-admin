...
<template>
    <div class="mx-4 px-4 pt-4 pb-6 bg-gray-200 dark:bg-gray-800 rounded-lg">
        ...
        <form @submit.prevent="submit" method="post">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-4">
                <div class="col-span-1 sm:col-span-2 md:col-span-3">
                    <div class="col-span-1 sm:col-span-2 md:col-span-3">
                        <InputLabel for="name">Nome do Marca</InputLabel>
                ...
                <div class="flex items-center col-span-1 sm:col-span-1 md:col-span-1">
                    <div class="w-full pr-2">
                        ...
                        <input class="form-control mt-2" type="checkbox" v-model="form.discontinued"
                            id="discontinued" />
        ...
        <div class="flex items-center justify-center w-full mt-4">
            ...
            <ButtonLink :href="route('brands.show')" class="w-1/6">
                Listar
            </ButtonLink>
        </div>
    </form>
