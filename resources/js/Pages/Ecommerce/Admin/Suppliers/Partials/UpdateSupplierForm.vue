...
import ImageSupplierForm from './ImageSupplierForm.vue';
...
const form = useForm({
  ...
  supplier_type_id: props.supplier?.supplier_type_id || '',
  user_id: props.supplier?.user_id || '',
  person_type: props.supplier?.person_type || '',
  document_number: props.supplier?.document_number || '',
  identification_number: props.supplier?.identification_number || '',
...
const updateSupplier = () => {
  form.put(route('supplier.update', { id: form.id }), {
    onSuccess: () => {
      if (props.jetstream) {
        props.jetstream.flash = { message: 'Fornecedor atualizado com sucesso!' };
      }
    },
    onError: () => {
      if (props.jetstream) {
        props.jetstream.flash = { error: 'Erro ao atualizar o fornecedor.' };
      }
    },
  });
};
        ...
        <form @submit.prevent="updateSupplier" enctype="multipart/form-data">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                <div class="col-span-1 sm:col-span-1 md:col-span-1">
                    <InputLabel for="supplier_type_id">Tipo de Cliente:</InputLabel>
                    <div class="flex items-center mt-1">
                        <select v-if="props.supplierTypes && props.supplierTypes.length"
                            ...
                            v-model="form.supplier_type_id" id="supplier_type_id">
                            <option v-for="supplier_type in props.supplierTypes" :key="supplier_type.id"
                                :value="supplier_type.id">
                                {{ supplier_type.name }}
                            </option>
                        </select>
                    </div>
                ...
                <div class="col-span-1 sm:col-span-1 md:col-span-1">
                    <InputLabel for="document_number">{{ form.person_type === 'Fisica' ?
                        'CPF' : 'CNPJ' }}
                    </InputLabel>
                ...
                <div class="col-span-1 sm:col-span-1 md:col-span-1">
                    <InputLabel for="identification_number">{{ form.person_type === 'Fisica'
                        ? 'DocumentoIdentidade'
                ...
                <div class="col-span-1 sm:col-span-1 md:col-span-1">
                    ...
                    <div class="relative flex">
                        ...
                        <button type="button" @click="buscarEnderecoPorCEP"
                            class="absolute top-0 right-0 underline-offset-2 py-3  px-2 space-x-2 text-sm  supplier_type  bg-gradient-to-r dark:from-cyan-900 dark:to-blue-900 from-blue-700  via-purple-700 to-purple-500   hover:dark:from-cyan-600 hover:dark:to-blue-600  bg-gray-600 hover:from-indigo-500 hover:via-purple-500 hover:to-purple-500 text-gray-100 rounded-r">
                            Buscar</button>
                    </div>
            ...
            <div class="flex items-center justify-center w-full mt-4">
                <ButtonLink :href="route('supplier.create')" :active="route().current('supplier.create')"
                ...
                <ButtonLink :href="route('suppliers.show')" :active="route().current('suppliers.show')"
                    class="w-1/3 sm:w-1/4 md:1/5 lg:w-1/6">
                    Listar
                </ButtonLink>
