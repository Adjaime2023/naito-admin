        ...
        <form @submit.prevent="submitFormLogoDark" method="post" enctype="multipart/form-data">
            <div class="grid justify-items-stretch items-center col-span-1 sm:col-span-1 md:col-span-1">
                ...
                <div class="flex justify-center mt-2 relative w-full" style="padding-bottom: 56.25%; height: 0;">
                    <img :src="logoDarkPreview" :alt="form.name"
...
const form = useForm({
    _method: 'PUT',
    logo_dark: props.partner.logo_dark, // Inicializa com a imagem existente da LogoDark
});

// Variável reativa para a pré-visualização da imagem
const logoDarkDefault = '/storage/images/default.png';
const logoDarkPreview = ref(props.partner.logo_dark ? `/storage/${props.partner.logo_dark}` : logoDarkDefault);
...
function submitFormLogoDark() {
    ...
    form.post(route('partner.updateImageLogoDark', { id: props.partner.id }), {
        onSuccess: () => {
