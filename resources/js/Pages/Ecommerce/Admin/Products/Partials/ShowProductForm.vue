                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <th class="px-2 py-2 text-xs">
                                    <div class="flex items-center"> <a class="text-sm">Marca</a></div>
                                </th>
                            ...
                            <tr v-for="product in products" :key="product.id" class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-2 py-2 text-sm">
                                    <button @click="togglePromotion(product)"
                                        ...
                                        <i v-else class="fa-solid fa-tags  text-green-500"
                                            title="Permanecer Produtos"></i>
                                    </button>
                                </td>
                    ...
                    <div class="flex justify-end flex-1 col-span-4 sm:col-span-2">
                        ...
                        <div class="flex items-center pl-4 space-x-2">
                            <select v-model="itemsPerPage" @change="fetchProducts"
                                class="px-4 py-2 border border-gray-300 text-sm font-medium  dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
